...
var _epage = __webpack_require__(2);
...
var Easyh5 = function () {
    ...
    function Easyh5(option) {
        _classCallCheck(this, Easyh5);

        this.el = (0, _common.getElement)(option.el) || document.body;
    ...
    _createClass(Easyh5, [{
        ...
        key: "_pageRender",
        value: function _pageRender() {
            console.log(this.page);
            if (this.page instanceof Array) {
                for (var item in this.page) {
                    if (this.page.hasOwnProperty(item)) {
                        if (this.page[item] instanceof Object) this.page[item] = new _epage.Epage(this.page[item]);else this.page[item] = new _epage.Epage({ el: this.page[item] });
...
var Epage = function () {
    ...
    _createClass(Epage, [{
        ...
        value: function _init() {
            ...
            (0, _common.setAttributes)(p, { 'id': this.el, 'class': 'e-page', 'style': 'height:' + document.documentElement.clientHeight + 'px; width: ' + document.documentElement.clientWidth + 'px;' });
            (0, _common.setAttributes)(e, { 'class': 'e-index-main', 'style': 'height:' + this.height + 'px; width: ' + this.width + 'px;' });
        ...
        key: '_pageScale',
        value: function _pageScale(page) {
            var clientWidth = document.documentElement.clientWidth;
            var clientHeight = document.documentElement.clientHeight;
            var pWidth = parseInt(page.style.width);
            var pHeight = parseInt(page.style.height);
            // 宽屏
